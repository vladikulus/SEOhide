...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('seohide_core_path', null,
                    $modx->getOption('core_path') . 'components/seohide/') . 'model/';
            $modx->addPackage('seohide', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/seohide/model/schema/seohide.mysql.schema.xml';
